...
// ==========================================
// Your specific connection string. Notice "mediflow" added before the ?
...
mongoose.connect(MONGO_URI)
    .then(() => {
        ...
        seedMedicines(); // We moved this here so it ONLY runs after a successful connection!
    })
...
app.post('/api/auth/send-otp', async (req, res) => {
    ...
    try {
        ...
        console.log(`🔑 Message: Your MediFlow OTP is ${generatedOtp}. Valid for 5 minutes.`);
        console.log(`--------------------\n`);
...
// --- SERVER START ---
// This tells it to use Render's port if available, or 3000 if on your PC
